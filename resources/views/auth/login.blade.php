    ...
    repeat();
        ...
        <div class="forms">
            ...
            <div class="form login">
                ...
                <form action="" method="POST" class="log-in-sign-in-form" autocomplete="off">

                    <span class="title">Welcome!</span>

                    <div class="input-field form-group">
                        <input type="text" placeholder="Enter Username" name="uname" class="is-invalid" required>
                        <span class="invalid-feedback"></span>
                        <i class="uil uil-envelope icon"></i>
                    </div>

                    <div class="input-field form-group">
                        <input type="password" id="password-field" spellcheck="false" placeholder="Enter password" name="pass" class="password is-invalid" required>
                        <span class="invalid-feedback"></span>
